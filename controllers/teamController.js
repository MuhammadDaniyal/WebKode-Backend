...
async function registerMember(req, res) {
    ...
    try {
        ...
        if (memberExist) {
            ...
            // create new user
            const regMemberDoc = new Team({ firstname, lastname, email, phone, university, discipline, shortbio })
            regMemberDoc.save()
                .then(result => res.status(201).send({ msg: "Member Register Successfully", result }))
